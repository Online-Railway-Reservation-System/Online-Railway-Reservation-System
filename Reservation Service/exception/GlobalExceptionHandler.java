...
import com.railway.reservation.dto.ErrorResponse;
...
public class GlobalExceptionHandler {
    ...
    public ResponseEntity<ErrorResponse> handleSeatUnavailable(SeatUnavailableException ex, HttpServletRequest request) {
        ErrorResponse err = new ErrorResponse(HttpStatus.CONFLICT.value(), "SEAT_NOT_AVAILABLE", ex.getMessage(), request.getRequestURI());
    ...
    public ResponseEntity<ErrorResponse> handlePaymentFailed(PaymentFailedException ex, HttpServletRequest request) {
        ErrorResponse err = new ErrorResponse(HttpStatus.PAYMENT_REQUIRED.value(), "PAYMENT_FAILED", ex.getMessage(), request.getRequestURI());
